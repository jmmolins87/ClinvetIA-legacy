...
const NAV: NavItem[] = [
  ...
  { href: "/admin/metrics", label: "Metrics", icon: "ChartLine", disabled: true },
        ...
        <div className="space-y-1">
          {NAV.map((item) => {
            ...
            return (
              ...
              >
                <Icon name={item.icon} className={cn("size-4", isActive && "text-gradient-to dark:text-primary")} />
